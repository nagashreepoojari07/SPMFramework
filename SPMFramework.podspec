Pod::Spec.new do |spec|
    ...
    spec.name = "SPMFramework"

    spec.version = "1.0"

    spec.summary = "FedProxyOauth includes SSO for FedProxyOauth"


    spec.description = 'Fed proxy Login'



    spec.homepage = "https://www.boeing.com"


    spec.license = { :type => "GNU AGPLv3", :file => "LICENSE" }
